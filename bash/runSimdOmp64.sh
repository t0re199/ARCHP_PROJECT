...
MAIN="../src/SoftSvmPolySimdOmp64.c"
ALGORITHM="../src/algorithm/avx/omp/SgdSimdOmp64.c"
INCLUDED_MODULES="../src/cli/*.c ../src/io/*.c ../src/random/*.c"
NASM_OBJECTS="$NASM_SRC*.o"
OUTPUT="../src/SoftSvmPolySimdOmp64.out"
...
gcc $GCC_ARCH_TYPE -msse -O0 -fopenmp -no-pie -o $OUTPUT $MAIN $ALGORITHM $INCLUDED_MODULES $NASM_OBJECTS -lm
