...
MAIN="../src/SoftSvmPolySimdOmp32.c"
ALGORITHM="../src/algorithm/sse/omp/SgdSimdOmp32.c"
INCLUDED_MODULES="../src/cli/*.c ../src/io/*.c ../src/random/*.c"
NASM_OBJECTS="$NASM_SRC*.o"
OUTPUT="../src/SoftSvmSimdOmp32.out"
...
gcc $GCC_ARCH_TYPE -msse -O0 -no-pie -fopenmp -o $OUTPUT $MAIN $ALGORITHM $INCLUDED_MODULES $NASM_OBJECTS -lm
